...
set_flag_proofTiming = writeIORef __cogent_proof_timing_ref True
set_flag_pruneCallGraph = writeIORef __cogent_prune_call_graph_ref . Just
...
set_flag_Wmono = writeIORef __cogent_wmono_ref True
...
set_flag_WnoMono = writeIORef __cogent_wmono_ref False
...
__cogent_cpp_args_ref = unsafePerformIO $ newIORef ["-x c", "$CPPIN", "-o", "$CPPOUT", "-P"]
...
__cogent_ddump_smt :: Bool
__cogent_ddump_smt = unsafePerformIO $ readIORef __cogent_ddump_smt_ref
...
__cogent_ddump_pretty_ds_no_tc :: Bool
__cogent_ddump_pretty_ds_no_tc = unsafePerformIO $ readIORef __cogent_ddump_pretty_ds_no_tc_ref
...
__cogent_name_cache_ref :: IORef (Maybe FilePath)
{-# NOINLINE __cogent_name_cache_ref #-}
__cogent_name_cache_ref = unsafePerformIO $ newIORef Nothing
...
__cogent_proof_timing :: Bool
__cogent_proof_timing = unsafePerformIO $ readIORef __cogent_proof_timing_ref

__cogent_proof_timing_ref :: IORef Bool
{-# NOINLINE __cogent_proof_timing_ref #-}
__cogent_proof_timing_ref = unsafePerformIO $ newIORef False

__cogent_prune_call_graph :: Maybe FilePath
__cogent_prune_call_graph = unsafePerformIO $ readIORef __cogent_prune_call_graph_ref

__cogent_prune_call_graph_ref :: IORef (Maybe FilePath)
{-# NOINLINE __cogent_prune_call_graph_ref #-}
__cogent_prune_call_graph_ref = unsafePerformIO $ newIORef Nothing
...
__cogent_wmono :: Bool
__cogent_wmono = unsafePerformIO $ readIORef __cogent_wmono_ref

__cogent_wmono_ref :: IORef Bool
{-# NOINLINE __cogent_wmono_ref #-}
__cogent_wmono_ref = unsafePerformIO $ newIORef False
